...
return {
  ...
  cog_minimal         = dir .. 'tag-list/' .. 'cog-minimal.svg',
	...
	neovim_minimal      = dir .. 'tag-list/' .. 'neovim-minimal.svg',
	sandbox             = dir .. 'tag-list/' .. 'sandbox.svg',
	social              = dir .. 'tag-list/' .. 'social.svg',
	social_minimal      = dir .. 'tag-list/' .. 'social-minimal.svg',
	spotify_minimal     = dir .. 'tag-list/' .. 'spotify-minimal.svg',
	terminal            = dir .. 'tag-list/' .. 'terminal.svg',
	terminal_minimal    = dir .. 'tag-list/' .. 'terminal-minimal.svg',
	text_editor         = dir .. 'tag-list/' .. 'text-editor.svg',
	web_browser         = dir .. 'tag-list/' .. 'web-browser.svg',
	web_browser_minimal = dir .. 'tag-list/' .. 'web-browser-minimal.svg',
